...
void Population :: Crossover(){
	...
	for(int i = 0; i < N; ++i) pop[num-2][i] = son1[i];	//sostituisco i figli agli ultimi due individui della poplazione ordinata se hanno lunghezza minore degli individui che vengono sostituiti
